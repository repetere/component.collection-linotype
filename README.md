# Linotype [![Build Status](https://travis-ci.org/yawetse/linotype.svg?branch=master)](https://travis-ci.org/yawetse/linotype) [![NPM version](https://badge.fury.io/js/linotypejs.svg)](http://badge.fury.io/js/linotypejs)
